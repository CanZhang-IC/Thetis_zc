...
H = 40
output_dir = '../../outputs/conference/restart-836629'
...
v_b = 10
v_inter = 1
h_viscosity = Function(P1_2d).interpolate(conditional(le(x[0], 50), v_b + v_inter-x[0]*v_b/50, conditional(ge(x[0],1950),(x[0]-1950)*v_b/50+v_inter,v_inter)))
...
# solver_obj.load_state(100, '../../outputs/conference/restart_original')
