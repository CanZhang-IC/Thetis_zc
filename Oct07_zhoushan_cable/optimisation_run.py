...
ouput_dir = 'outputs/meiyongdefangxinshan'
...
#solver_obj.load_state(340, outputdir='/media/can/can_disk/thetis_new/zhoushan_discrete/outputs/test')
...
if 1:
    ...
    xmin,ymin,xmax,ymax = 443314.1,3322622.4,443617.4,3322857.8
    m1 = [[Constant(x), Constant(y)] for x in numpy.arange(xmin+20, xmax-20, 60) for y in numpy.arange(ymin+20, yamx-20, 40)]
