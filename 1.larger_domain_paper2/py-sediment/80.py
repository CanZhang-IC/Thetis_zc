...
sediment_size,morfac,diffusivity,morphological_viscosity = the_fac*1e-6,1,0.2,1e-6
output_dir = '../../../outputs/1.larger_domain_paper2/sediment-exner-to_neap/'+str(sediment_size)
...
# restarting
# solver_obj.load_state(288,outputdir='../outputs/sediment-hydro')
...
end_time = time.time()
print('time cost: {0:.2f}h'.format((end_time - start_time)/60/60))
