...
start_time_point = 676-6

output_dir = '../../../outputs/0.validation/sediment-nis/A-s'
...
solver_obj.load_state(start_time_point,outputdir='../../../outputs/paper2validation-4cores')
