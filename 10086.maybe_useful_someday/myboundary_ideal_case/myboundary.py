...
min_x, min_y,max_x,max_y= 4500,800,15500,3200 # this is where you should make changes
...
large_mesh2d = Mesh('large_domain/large_domain.msh')
...
h5file_dir = 'large_domain/outputs/hdf5'
