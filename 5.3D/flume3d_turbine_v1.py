...
n_layers = 9
outputdir = '../../outputs/5.3D/dx150_v1_original_scale'
lx = 50
ly = 1.2
nx = 200
ny = 12
...
def update_forcings(t):
    u_ramped.assign(tanh(t/10.)*u_in)
...
for i in xx:
    for j in yy:
        for k in zz:
            locations.append((turbine_xyz[0] + D*i, turbine_xyz[1] + D*j,-k))
            names.append('name'+str((i,j,k)))
# locations,names = [(25,0.6,-0.27)],['test']
