...
# BE =2.0 # 'start from non-yaw'


output_dir = '../../../outputs/2.economy/discrete/intermediate-2-forward/yaw-cable-BE-'+str(BE)[:-2]
...
if BE == 'start from non-yaw':
    ...
    result_output_dir = '../../../outputs/2.economy/discrete/intermediate-1-l/yaw-cable-BE-'+str(BE)[:-2]
    comm = MPI.COMM_WORLD
    rank = comm.Get_rank()
    if rank == 0:
...
interest_functional = (BE/10*power_output/maxoutput-(1-BE/10)*cablecost/maxcost)*2000
