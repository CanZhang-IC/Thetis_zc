...
output_dir = '../../../outputs/2.economy/discrete/intermediate-3-forward/yaw-cable-BE-'+str(BE)[:-2]
...
if BE == 'start from non-yaw':
    ...
    result_output_dir = '../../../outputs/2.economy/discrete/intermediate-2-l_y/yaw-cable-BE-'+str(BE)[:-2]
    comm = MPI.COMM_WORLD
    rank = comm.Get_rank()
    if rank == 0:
