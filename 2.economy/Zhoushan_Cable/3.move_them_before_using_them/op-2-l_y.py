...
output_dir = '../../../outputs/2.economy/discrete/intermediate-2-l_y/test/yaw-cable-BE-'+str(BE)[:-2]
...
if start_from_initial:
    ...
    result_output_dir = '../../../outputs/2.economy/discrete/intermediate-2-l/yaw-cable-BE-'+str(float(BE-1))[:-2]
