...
output_dir = '../../../outputs/2.economy/discrete/intermediate_forward/yaw-cable-BE-'+str(BE)[:-2]
...
result_output_dir = '../../../outputs/2.economy/discrete/intermediate/yaw-cable-BE-'+str(BE)[:-2]
comm = MPI.COMM_WORLD
rank = comm.Get_rank()
if rank == 0:
