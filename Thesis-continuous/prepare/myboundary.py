...
large_mesh2d = Mesh('./larger_field_paper2/mesh/mesh.msh') # this is where you should make changes 
...
h5file_dir = './larger_field_paper2/outputs/5min-4cores-220428/hdf5' # this is where you should make changes 
