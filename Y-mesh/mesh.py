...
gradationRaster_shoreline_2.setGradationParameters(100.0,1500.0,0.1) 
gradationRaster_shoreline_2.calculateLinearGradation()

#meshMetricRaster.writeNetCDF('meshMetric.nc)
meshMetricRaster = gradationRaster_shoreline_2
...
domain.setGeometry(innerSound_plot_loops, innerSound_plot_polygon)
