...
E_area_centre_point1 = [443320,3323280] 
E_area_circle1 = 60

E_area_centre_point2 = [443600,3322200] 
E_area_circle2 = 60
...
maxoutput, maxcost, diff_uv = 3826.961013808611, 1968.6394624114741-3*shortestline, (5170.130694355489 + 6647.679891516789)/2 #full情况下的输出，后续如果与峰值的输出相差很大，通过除以调整到同一量级
