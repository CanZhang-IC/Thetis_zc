...
# BEcable,BEsediment = 0.0,2.0


t1_end, t2_end = 502, 514
file_dir = '../../'
output_dir = '../../../outputs/8.final/cable-velocity/'+str(BEcable)[:-2] + '-'+ str(BEsediment)[:-2] 
...
result_output_dir = '../../../outputs/8.final/cable-velocity/'+str(BEcable)[:-2] + '-'+ str(BEsediment-2)[:-2]
comm = MPI.COMM_WORLD
rank = comm.Get_rank()
if rank == 0:
...
power_output = (power_output1*2+power_output2)/2
...
maxoutput, maxcost, diff_uv = 3516.141313665352, 1968.6394624114741-3*shortestline, (5602.319901599994+4479.962038698644)/2

interest_functional = (2-BEcable/10-BEsediment/10)*power_output/maxoutput/3*diff_uv - BEcable/10*(cablecost-3*shortestline)/maxcost*diff_uv - BEsediment/10*effect_two/4

print_output(power_output1,effect_two1)
print_output(power_output2,effect_two2)
print_output(power_output/maxoutput,(cablecost-3*shortestline)/maxcost,effect_two)
print_output(power_output/maxoutput*diff_uv,(cablecost-3*shortestline)/maxcost*diff_uv,effect_two)
