...
output_dir = '../../../outputs/8.final/forward_just_power'
...
cb2 = rmse_sediment.RMSECallback(solver_obj,'../../../outputs/0.validation/sediment-nis/D-i', E_area_centre_point, E_area_circle,492)
...
# Operation of tidal turbine farm about each turbine output through a callback
cb3 = rmse_sediment.RMSECallback(solver_obj,'../../../outputs/0.validation/sediment-nis/D-i', E_area_centre_point, E_area_circle,492)
...
# Operation of tidal turbine farm about each turbine output through a callback
cb4 = rmse_sediment.RMSECallback(solver_obj,'../../../outputs/0.validation/sediment-nis/D-i', E_area_centre_point1, E_area_circle1,492)
...
if rank ==0:
    with open('result.txt','a+') as f:
        f.write(str(interest_functional)+'\t'+str(effect_two)+'\t'+str(cablecost)+'\t'+str(power_output)+'\t')
