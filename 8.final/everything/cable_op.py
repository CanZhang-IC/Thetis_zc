...
output_dir = '../../../outputs/2.economy/discrete/intermediate/test'#cable-BE-'+str(BE)[:-2]
...
turbine_location = []
for x in range(xmin+d,xmax-d,60):
    for y in range(ymin+d,ymax-d,60):
...
File('turbinedensity.pvd').write(turbine_density)
