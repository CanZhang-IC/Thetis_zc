...
namelength = len('one_turbine')
angle = float(get_index[namelength:-3])


H = 0.5
speed = -0.33

output_dir = '../../../outputs/0.validation/experiment_turbine/0.6-1.5structure/'+str(angle)
...
farm_options.turbine_options.C_support = 1.5
