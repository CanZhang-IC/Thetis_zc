...
import sys
sys.path.append('../..')
import prepare.utm, prepare.tidal_forcing, prepare.detectors
import os
import time
import yagmail
...
output_dir = '../../../outputs/0.validation/discrete-4cores-tideforcing'
...
def update_forcings(t):
    with timed_stage('update forcings'):
        ...
        prepare.tidal_forcing.set_tidal_field(tidal_elev, t)
