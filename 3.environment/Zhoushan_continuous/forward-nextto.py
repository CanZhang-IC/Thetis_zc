...
BE,BE_sediment = 5.0,0.0

###spring:676,middle:492,neap:340###
start_time_point = 486

output_dir = '../../../outputs/3.environment/zhoushan-continuous-forward/nextto/'+str(BE)[:-2]+'_'+str(BE_sediment)[:-2]
...
# chk = DumbCheckpoint('../../../outputs/3.environment/zhoushan-continuous-op/nextto_notfrom0/'+str(BE)[:-2]+'_'+str(BE_sediment)[:-2]+'/optimal_density', mode=FILE_READ)
...
#Effected area location
E_area_centre_point = [[444203,3322485]]#[[442973,3321135]] #next to
E_area_circle = [200]
...
profit_max,sediment_max = 26818.31114896429, 409.8897313653227
