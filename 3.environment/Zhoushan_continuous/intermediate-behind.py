...
chk = DumbCheckpoint('../../../outputs/3.environment/zhoushan-continuous-op/behind_notfrom0/'+str(BE)[:-2]+'_'+str(BE_sediment-25)[:-2]+'/optimal_density', mode=FILE_READ)
...
scaled_functional = (1-BE_sediment/100)*cb.average_profit[-1]/profit_max- effect_two[0] * BE_sediment/100/sediment_max
