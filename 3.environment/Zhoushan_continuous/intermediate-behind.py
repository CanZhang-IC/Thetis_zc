...
output_dir = '../../../outputs/3.environment/zhoushan-continuous-op/behind_notfrom0/'+str(BE)[:-2]+'_'+str(BE_e)[:-2]
...
chk = DumbCheckpoint('../../../outputs/3.environment/zhoushan-continuous-op/behind/'+str(15.0)[:-2]+'_'+str(15.0)[:-2]+'/optimal_density', mode=FILE_READ)
...
# if rank ==0:
#     with open('result-behind.txt','a+') as f:
#         f.write(str(BE)+'\t')
