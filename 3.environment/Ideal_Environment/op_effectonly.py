...
H = 40
output_dir = '../../../outputs/3.environment/op_effectonly'
...
timestep = 300
t_export = 600
t_end = 63*t_export #+ tidal_period 
...
def eval_cb_pre(controls):
    ...
    print_output("Location: {}".format([float(c) for c in controls]))
...
if optimise:
    ...
    if optimise_angle_only:
        ...
        mdc= turbines.MinimumDistanceConstraints(farm_options.turbine_coordinates, farm_options.turbine_axis, 30.)
