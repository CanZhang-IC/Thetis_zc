...
boundaries.fromFile('turblines.shp')  # Domain file
...
innerSound_plot_lines.fromFile('tl2.shp')
...
GSHHS_fine_boundaries.fromFile('turbcoast.shp')  # Coastline file
gradationRaster_shoreline = qmesh.raster.gradationToShapes()
gradationRaster_shoreline.setShapes(GSHHS_fine_boundaries)
gradationRaster_shoreline.setRasterBounds(122.0,122.8,29.7,30.3)  # lonmin, lonmax, latmin, latmax
gradationRaster_shoreline.setRasterResolution(1500,1500)
gradationRaster_shoreline.setGradationParameters(200.0,1500.0,0.2)  # resmin, resmax (m), rate of change
gradationRaster_shoreline.calculateLinearGradation()
gradationRaster_shoreline.writeNetCDF('gradation_to_lines.nc')
...
gradationRaster_shoreline_1.setGradationParameters(50.0,1500.0,0.1,0.001)  # resmin, resmax (m), rate of change
...
gradationRaster_shoreline_2.setGradationParameters(5,1500.0,0.1) 
...
meshMetricRaster = qmesh.raster.meshMetricTools.minimumRaster([gradationRaster_shoreline, gradationRaster_shoreline_1,\
