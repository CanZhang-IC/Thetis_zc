...
output_dir = '../../../outputs/1.energy/discrete/flood_ebb/sta-90'
...
interest_functional = (power_output+power_output2)/2


# specifies the control we want to vary in the optimisation
c = [Control(i) for i in farm_options.turbine_axis]
...
if 1:
    ...
    td_opt = minimize(rf, method='SLSQP', bounds=[lb,ub],
