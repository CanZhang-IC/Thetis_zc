...
output_dir = '../../../outputs/1.energy/discrete/sta-forward-noyaw'
...
result_output_dir = '../../../outputs/1.energy/discrete/flood_ebb/sta-90'
comm = MPI.COMM_WORLD
rank = comm.Get_rank()
if rank == 0:
...
flood_dir,ebb_dir = all_controls[:18], all_controls[18:]
