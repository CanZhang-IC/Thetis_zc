...
namelength = len('intermediate-op-l_y_vary')
P_factor = float(get_index[namelength:-3])

# P_factor = 1

output_dir = '../../../outputs/6.yaw_environment/Paper3/Zhoushan_mesh_30min/optimisation/intermediate-op-l_y_vary-P_factor_'+str(P_factor)
