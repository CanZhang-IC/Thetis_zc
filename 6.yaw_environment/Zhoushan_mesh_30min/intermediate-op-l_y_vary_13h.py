...
# namelength = len('intermediate-op-l_y_vary_13h')
# P_factor = float(get_index[namelength:-3])

P_factor = 1

output_dir = '../../../outputs/6.yaw_environment/Paper3/Zhoushan_mesh_30min/optimisation/13h/intermediate-op-l_y_vary-P_factor_'+str(P_factor)
...
if 1:
    ...
    if rank == 0 :
        ...
        yag.send(to = ['canzhang2019@gmail.com'], subject = 'Python done', contents = ['Location and Yaw Optimisation '+str(P_factor)+'of 13h cost:'+str((t_end - t_start)/60/60)+'h.'])
    else:
        pass
