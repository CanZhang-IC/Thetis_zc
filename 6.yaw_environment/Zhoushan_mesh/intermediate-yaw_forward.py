...
output_dir = '../../../outputs/6.yaw_environment/Paper3/Zhoushan_mesh/optimisation/test'#intermediate-yaw_forward-5min_e&v'
print_output('Test!!!')
print_output('n = conditional(dot(self.uv,as_vector((0,1)))>0 , n_ebb, n_flood)')
print_output('flood_dir,ebb_dir  ')
...
flood_dir,ebb_dir = [165.8640292973645, 168.36729580057818, 164.72883406461412, 165.34564861038413, 163.30049720086222, 162.14254770317606, 161.97475425414152, 158.81132651553807, 166.32109351956223, 163.80978661838327, 161.2350866676445, 159.73651090877559], [351.1755091556007, 353.35364279713525, 349.7951854484197, 350.42196703680355, 347.7200972166608, 347.19899221016414, 345.04356664941355, 343.7807551299438, 351.57340339401173, 349.3688085942667, 346.38613201878877, 344.11228363835716]
