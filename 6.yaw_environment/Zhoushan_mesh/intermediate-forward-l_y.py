...
output_dir = '../../../outputs/6.yaw_environment/Paper3/Zhoushan_mesh/optimisation/forward/intermediate-forward-l_y-P_factor_'+str(P_factor)+'-5min_e&v'
...
result_output_dir = '../../../outputs/6.yaw_environment/Paper3/Zhoushan_mesh/optimisation/intermediate-op-l_y-P_factor_'+str(P_factor)+'-5min_e&v'
comm = MPI.COMM_WORLD
rank = comm.Get_rank()
if rank == 0:
