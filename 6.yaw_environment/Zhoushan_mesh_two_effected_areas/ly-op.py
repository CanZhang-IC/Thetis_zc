...
result_output_dir = '../../../outputs/6.yaw_environment/Paper3/Zhoushan_mesh/optimisation/backhome-two_effected/intermediate-op-l_y-P_factor_'+str(0.4)+'-5min_e&v-location'
comm = MPI.COMM_WORLD
rank = comm.Get_rank()
if rank == 0:
