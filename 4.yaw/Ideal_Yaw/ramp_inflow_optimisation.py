...
speed = 2
distance = 10
output_dir = '../../../outputs/4.yaw/Yaw_Ideal/opendoundary/optimisation-'+str(distance)+'D-ramp-inflow'
...
farm_options.turbine_coordinates =[
    [Constant(800-2*distance*20),Constant(50)],[Constant(800-distance*20),Constant(60)],[Constant(800),Constant(40)],
    ]
...
if 0:
    ...
    m0 = [Constant(10), Constant(20), Constant(30)] *2
    h0 = [Constant(1), Constant(1), Constant(1)]*2
