...
distance = 2
speed = 2
output_dir = '../../../outputs/4.yaw/Yaw_Ideal/forward_run'
...
farm_options.turbine_coordinates =[
    [Constant(800-2*distance*20),Constant(50)],[Constant(800-distance*20),Constant(50)],[Constant(800),Constant(50)],
    ]

farm_options.considering_yaw = True
a_list = [7.35736328e-12, 1.92462161e-11, 5.69794736e-11, 3.48084533e+00,9.72258416e+00, 1.84554446e+01]
# farm_options.turbine_axis = [Constant(0) for i in range(len(farm_options.turbine_coordinates)*2)]
farm_options.turbine_axis = [Constant(i) for i in a_list]
...
def update_forcings(t):
    ...
    ramp = tanh(t / 2000.)
    tidal_vel.project(-ramp*Constant(speed))
