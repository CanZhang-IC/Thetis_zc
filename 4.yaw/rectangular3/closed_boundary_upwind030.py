...
distance = 10
speed = 2
output_dir = '../../../outputs/4.yaw/Yaw_Ideal/test'#rectangular3/f30-cos22/angle'+str(angle)+'H'+str(H)
...
farm_options.turbine_options.C_support = 0.9
farm_options.turbine_options.A_support = 20
