...
H = 40
output_dir = '../../../outputs/4.yaw/Conference2/oneturbineoptimisation3'
...
farm_options.turbine_axis = [Constant(249.92454344983014), Constant(106.87990126044483)]
...
if rank == 0 :
    ...
    yag.send(to = ['canzhang2019@gmail.com'], subject = 'Python done', contents = ['One turbine optimisation finishes. The time cost is:' + str(int((t_end-t_start)/60)) + 'min.'])
