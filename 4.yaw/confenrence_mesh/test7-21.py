...
distance = 10
speed = 2
output_dir = '../../../outputs/4.yaw/SeeAngles/SeeAngles-'+str(angle)
...
farm_options.turbine_coordinates =[
    [Constant(1000),Constant(300)] 
    ]

farm_options.considering_yaw = True
farm_options.turbine_axis = [Constant(angle) for i in range(len(farm_options.turbine_coordinates))] + [Constant(angle+180) for i in range(len(farm_options.turbine_coordinates))]
