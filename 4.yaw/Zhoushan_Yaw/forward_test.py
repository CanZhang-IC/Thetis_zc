...
output_dir = file_dir+'../outputs/4.yaw/Yaw_Zhoushan/test'+str(angle)
...
farm_options.turbine_coordinates = [
    [Constant((site_x1+site_x2)/2),Constant((site_y1+site_y2)/2)]
    # [Constant(x), Constant(y)] for x in numpy.arange(site_x1+20, site_x2-20, 60) for y in numpy.arange(site_y1+20, site_y2-20, 50)
    ]
...
solver_obj.load_state(676, outputdir=file_dir+'../outputs/redata_30min_normaldepth')
