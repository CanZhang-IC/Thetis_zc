...
Point(200) = {0,200,0, element_size_coarse};
Point(201) = {1000,200,0, element_size_coarse};
...
Point(300) = {0,-100,0, element_size_coarse};
Point(301) = {1000,-100,0, element_size_coarse};
